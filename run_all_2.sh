...
echo "[BASH] Preprocessing I3D data (only optical flow)..."
uv run scripts/preprocess_i3d.py --config scripts/config.yaml --steps flow \
  > $LOG_DIR/preprocess_i3d_optical.log 2>&1
